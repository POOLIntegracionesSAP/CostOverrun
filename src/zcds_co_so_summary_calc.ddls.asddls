...
@EndUserText.label: 'Cost Overrun for SO - Summary Calc'
@Metadata.allowExtensions: true

// CDS view to select the main values from the Cost Overrun calculation for summarization purposes
define view entity ZCDS_CO_SO_SUMMARY_CALC as select from ZCDS_CO_SO_DETAIL_CALC as DetailCalculation
{
// The primary keys are Company Code, Sales Order, SO Item and the combination of Type and Classification
    @EndUserText.label: 'Company Code'
key DetailCalculation.companycode as companycode,
    @EndUserText.label: 'Sales Order'
key DetailCalculation.salesdoc as salesdoc,
    @EndUserText.label: 'Sales Order Item'
key DetailCalculation.salesdocitem as salesdocitem,
...
// Sum of the actual amounts for all entries of the SO Item
    @EndUserText.label: 'ACDOCA'
    @Semantics.amount.currencyCode: 'companycodecurrency'
    cast(DetailCalculation.actualamount_sum as abap.curr( 10, 2 )) as actualamount_sum,
// Sum of the plan amounts for all entries of the SO Item
